test(async () => {
    ...
    assertEquals(originalRows + 1, newRows, "Nem megfelelő sort fűzött hozzá a táblázathoz");
    ...
    assertEquals(1, lastRow[0].rowspan, "A hozzáadott táblázathoz hozzáadott elem 1. sor 1. oszlopának rowspan értéke nem jó");
    for (let i = 0; i < lastRow.length; i++) {
        ...
        assertEquals(1, lastRow[i].rowspan, `A hozzáadott táblázathoz hozzáadott elem 1. sor ${i + 1}. oszlopának rowspan értéke nem jó`);
    }
    return true;
})